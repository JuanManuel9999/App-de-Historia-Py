...
function obtenerConfiguracion()
{
    ...
    if ($row['total'] == '0') {
        ...
        $query = "INSERT INTO config (id, usuario, password, totalPreguntas) VALUES (NULL, 'admin', 'admin', '3')";
...
function obtenerCategorias(){
    ...
    // Contamos la cantidad de cada categoria
...
{
    include "conexion.php";
    $query = "SELECT * FROM jugadores ORDER BY porcentaje DESC";
    $result = mysqli_query($conn, $query);
    return $result;
}